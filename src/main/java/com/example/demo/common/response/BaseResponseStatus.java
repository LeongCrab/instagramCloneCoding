...
public enum BaseResponseStatus {
    ...
    ENUM_ERROR(false, HttpStatus.BAD_REQUEST.value(), "올바른 State 값을 입력해주세요"),
    ...
    BIRTHYEAR_ENCRYPTION_ERROR(false, HttpStatus.INTERNAL_SERVER_ERROR.value(), "생년 암호화에 실패하였습니다."),
